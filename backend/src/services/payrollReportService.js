...
// STRICT filtering: a branch view shows only runs tagged with that branch (branch_id = <id>).
// Legacy NULL-branch runs must be backfilled via backfill_payroll_run_branch_ids_2026_09_25.sql
// — otherwise they only appear in the "All Branches" view.
